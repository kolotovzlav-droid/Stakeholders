...
4. Открытый микрофон #1. Как взаимодействовать со стейкхолдерами? / Спикер: Д. Шорохов; эксперты: А. Петухов, М. Заборов, А. Нечитайло, М. Харитонов, А. Сможенков; канал «Со-Общество | Спортмастер»// Хабр. Блог компании SM Lab. — 2023. — URL: https://habr.com/ru/companies/sportmaster_lab/articles/778386Карл Вигерс, Джой Битти «Разработка требований к программному обеспечению» издание третье.
...
![img1](misc/images/School_21_-_Луковичная_диаграмма.jpg)
...
### Exercise 00 — Выявление заинтересованных сторон <div id="51"></div>
**Для задачи 2:**
...
### Exercise 01 — Построение луковичной диаграммы <div id="52"></div>
**Для задачи 2:**
...
![img2](misc/images/School_21_-_Пример_луковичной_диаграммы_для_задачи_1.jpg)

### Exercise 02 — Интересы, потребности, проблемы заинтересованных сторон <div id="53"></div>
**Для каждой задачи:**
...
### Exercise 03 — Наполнение глоссария <div id="54"></div>
**Для каждой задачи:**
